...
par(mfrow=c(2,2))
# top-left
plot(data$Time, data$Global_active_power, type="n", main="", xlab="", ylab="Global Active Power")
lines(data$Time, data$Global_active_power)
# top-right
plot(data$Time, data$Voltage, type="n", main="", xlab="datetime", ylab="Voltage")
...
# bottom-right
plot(data$Time, data$Global_reactive_power, type="n", main="", xlab="datetime", ylab="Global_reactive_power")
